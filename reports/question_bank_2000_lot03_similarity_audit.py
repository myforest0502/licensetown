"""Audit any completed Lot03 authoring chunk against all formal Q1-Q1857 stems."""
...
OUT_DIR = ROOT / "reports" / "question_bank_2000_lot03_similarity_audits"
NEAR = 0.65
HARD = 0.78
...
def audit(chunk_no: int) -> dict:
    ...
    if max(int(row["id"][1:]) for row in formal) != 1857:
        raise ValueError("Lot03 similarity audit requires formal Q1-Q1857")
    ...
    if chunk.get("formal_baseline") != "Q1-Q1857":
        raise ValueError("Lot03 chunk formal baseline mismatch")
