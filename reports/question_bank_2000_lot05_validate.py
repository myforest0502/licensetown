...
base.ROSTER=ROSTER;base.STAGING=STAGING;base.CATEGORY_QUOTA=CATEGORY_QUOTA;base.TASK_QUOTA=TASK_QUOTA;base.LEVEL_QUOTA=LEVEL_QUOTA;base.SLOT_QUOTA=SLOT_QUOTA;base.SAFETY_AUGMENT=SAFETY_AUGMENT;base.MIN_STRONG=MIN_STRONG;base.BASE_COUNT=BASE_COUNT;base.BASE_VERSION=BASE_VERSION;base.INTEGRATED_START=INTEGRATED_START;base.INTEGRATED_END=INTEGRATED_END;base.INTEGRATED_VERSION=INTEGRATED_VERSION
