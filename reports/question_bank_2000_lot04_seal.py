"""Seal a fully authored and reviewed Lot04 staging file after pre-seal validation."""
...
def main() -> int:
    ...
    if report["hard_errors"]:
        ...
        raise SystemExit("Lot04 cannot be sealed while pre-seal validation has hard errors")
    ...
    if final_report["hard_errors"]:
        ...
        raise SystemExit("Lot04 sealing produced an invalid final staging state")
    print(json.dumps({
        "sealed": True,
