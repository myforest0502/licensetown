"""Seal a fully authored and reviewed Lot02 staging file without approving content itself."""
...
def main() -> int:
    ...
    if report["hard_errors"]:
        ...
        raise SystemExit("Lot02 cannot be sealed while pre-seal validation has hard errors")
    ...
    if final_report["hard_errors"]:
        ...
        raise SystemExit("Lot02 sealing produced an invalid final staging state")
    print(json.dumps({
        "sealed": True,
