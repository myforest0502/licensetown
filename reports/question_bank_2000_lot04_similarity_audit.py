"""Audit any completed Lot04 authoring chunk against all formal Q1-Q1905 stems."""
...
OUT_DIR = ROOT / "reports" / "question_bank_2000_lot04_similarity_audits"
NEAR = 0.65
HARD = 0.78
...
def audit(chunk_no: int) -> dict:
    ...
    if chunk.get("formal_baseline") != "Q1-Q1905":
