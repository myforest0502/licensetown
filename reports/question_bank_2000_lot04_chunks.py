"""Merge six completed Lot04 8-draft authoring chunks into one staging lot."""
...
FINAL = ROOT / "staging" / "question_bank_2000_lot04_v01.json"
CHUNK_SIZE = 8
CHUNK_COUNT = 6
...
def merge() -> None:
    ...
    final = {
        "batch": "question_bank_2000_production_lot04_v01",
        ...
        "chunk_merge_provenance": {
            ...
            "chunks": [f"question_bank_2000_lot04_chunks_v01/chunk_{i:02d}.json" for i in range(1, 7)],
        },
    }
