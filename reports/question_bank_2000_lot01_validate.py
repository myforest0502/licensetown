"""Fail-closed staging validator for Question Bank 2000 production Lot 01."""
...
STAGING = ROOT / "staging" / "question_bank_2000_lot01_v01.json"
PROTECTED = (
    "questions.json",
    "answers.json",
    "explanations.json",
...
def build_report(payload: dict | None = None, *, require_seals: bool = True) -> dict:
    ...
    check(payload.get("batch") == "question_bank_2000_production_lot01_v01", "batch id mismatch")
