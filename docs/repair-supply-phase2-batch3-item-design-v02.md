...
**Rationale:** 手の外来筋は筋腹・起始が前腕側にあり、腱が手へ入って手指に作用する筋群である。短母指伸筋などはその代表である。停止部が手にあることだけで内在筋になるわけではなく、筋腹が手内にある母指球筋・小指球筋・骨間筋などとは区別される。Q1200の筋名暗記ではなく、観察された筋腹と腱走行から外来筋の定義を解釈する。
