...
def test_remaining_allocation_balances_to_2000():
    ...
    assert report["used"]["node_slot"] == {
        "multi_reinforcement": 37, "new_node": 18, "singleton_second": 161,
    }
    assert report["used"]["strong_formations"] == 198
