"""Provisional shadow-only Exam Weight model for PT."""
...
TOTAL_ORIGINAL_ITEMS = 1133
KNOWN_YEAR_PROVENANCE_ITEMS = 36
YEAR_PROVENANCE_GAP = TOTAL_PAST_EXAM_ITEMS - KNOWN_YEAR_PROVENANCE_ITEMS

FIELD_NAMES = {
    1: "解剖学", 2: "生理学", 3: "心理学", 4: "人間発達学", 5: "教育学",
    6: "医学概論", 7: "病理学", 8: "内科学", 9: "神経医学", 10: "精神医学",
    11: "小児学", 12: "臨床心理学", 13: "基礎運動学", 14: "臨床運動学",
    15: "動作分析学", 16: "運動器", 17: "理学療法評価各論", 18: "理学療法治療各論",
}
FIELD_PAST_EXAM_COUNTS = {
    1: 137, 2: 152, 3: 15, 4: 22, 5: 6, 6: 34, 7: 63, 8: 118, 9: 65,
    10: 35, 11: 16, 12: 13, 13: 50, 14: 5, 15: 25, 16: 53, 17: 87, 18: 204,
}
