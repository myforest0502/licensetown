...
from licensetown.common.durable_paused_session import install_durable_paused_sessions
from licensetown.common.durable_web_learning_session import install_durable_web_learning_sessions
