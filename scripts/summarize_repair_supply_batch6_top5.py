...
ids=['Q820','Q903','Q1054','Q1057','Q1089']
...
lines=['# Repair Supply Phase2 batch6 top5 source context','']
for qid in ids:
...
Path('docs/repair-supply-phase2-batch6-top5-source-context.md').write_text('\n'.join(lines),encoding='utf-8')
